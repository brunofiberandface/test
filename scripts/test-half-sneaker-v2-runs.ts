...
const BASE_URL = 'https://storage.googleapis.com/gstar-ai-studio-assets/experiments/sole-mode/halfsneaker-v2-1779246000/base.png';
...
const OUT_DIR = path.join(projectRoot, 'test_outputs/sole-mode/half-sneaker-v2');
